...
website_route_rules = [{'from_route': '/social media management/<path:app_path>', 'to_route': 'social media management'}, {'from_route': '/frontend/<path:app_path>', 'to_route': 'frontend'},]